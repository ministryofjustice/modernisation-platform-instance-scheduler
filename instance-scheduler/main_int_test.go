...
func TestHandler(t *testing.T) {
	t.Run("Test request", func(t *testing.T) {
		...
		os.Setenv("INSTANCE_SCHEDULING_SKIP_ACCOUNTS", "shared-services-dev,analytical-platform-development,analytical-platform-data-engineering-sandbox-a,analytical-platform-compute-development,analytical-platform-compute-test,analytical-platform-data-development,bichard7-sandbox-a,bichard7-sandbox-b,bichard7-sandbox-c,bichard7-sandbox-shared,bichard7-shared,bichard7-test-current,bichard7-test-next,core-vpc-development,core-vpc-preproduction,core-vpc-sandbox,core-vpc-test,mi-platform-development,nomis-preproduction,")
